...
# Last Modified: 2 october 2012 - updated budding and fission yeast 
...
# <a href="../htdocs/PInt/protint_index.htm">Reset search</a>);
	print qq(<p><FORM METHOD="LINK" ACTION="http://www.bahlerlab.info/PInt"> <INPUT 
TYPE="submit" VALUE="Reset search"></FORM>);
...
#	my $fin="/var/www/htdocs/PInt/n_aug10_compUY2H_pbort.txt";
	my $fin="/var/www/htdocs/PInt/sep12_protintspbort.txt";
...
#	my $fin="/var/www/htdocs/PInt/n_aug10compUY2H_pb.txt";
	...
	my $fin="/var/www/htdocs/PInt/sep12_pbprotints.txt";
	open(INFILE, "<$fin") or die("Cannot open file $fin\n");
	my @conv=<INFILE>;
	chomp(@conv);
	close(INFILE);
...
sub getpbgen{
	my $fin="/var/www/htdocs/PInt/sep12genpb.txt";
	open(INFILE, "<$fin") or die("Cannot open file $fin\n");
	my @conv=<INFILE>;
	chomp(@conv);
	close(INFILE);
...
sub getcergen{
	...
	my $fin="/var/www/htdocs/PInt/sep12gencer_pbort.txt";
	open(INFILE, "<$fin") or die("Cannot open file $fin\n");
	my @conv=<INFILE>;
	chomp(@conv);
	close(INFILE);
